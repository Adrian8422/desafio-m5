...
export function initCounterComponent() {
  class CounterCom extends HTMLElement {
    shadow: ShadowRoot;
    constructor() {
      super();
    ...
    render() {
      ...
      let number: any = div.querySelector(".numero");
  ...
  customElements.define("counter-element", CounterCom);
}
